...
SELECT ROUND(123.126,1)FROM DUAL;--소수점 둘째 자리에서 반올림(소수점 첫번째 자리까지 표기)
...
SELECT TRUNC (123.456,-1) FROM DUAL;--10의자리 아래를 절삭
...
SELECT MONTHS_BETWEEN(SYSDATE,'2025-07-22')FROM DUAL;
...
SELECT TO_CHAR(1000000,'9,999,999')||'원' FROM DUAL; --패턴 지정
